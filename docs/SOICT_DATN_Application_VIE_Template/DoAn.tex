...
% Lệnh hỗ trợ copy text từ PDF không bị lỗi font hay mất dấu phụ / dấu cách
\usepackage{cmap}
...
\usepackage{tabularx} % Tự động co giãn cột bảng
...
\usepackage{outlines} % Hỗ trợ danh sách outline trong Phụ lục A
