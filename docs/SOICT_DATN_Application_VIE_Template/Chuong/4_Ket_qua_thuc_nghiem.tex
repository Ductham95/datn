...
%todo: Biểu đồ gói UML tổng quan (package diagram)
\begin{figure}[h]
    \centering
...
%todo: Sơ đồ mạch Sensor Node — user tự thêm hình
...
%todo: Sơ đồ mạch Gateway — user tự thêm hình
...
\hline
\textbf{Thành phần} & \textbf{Số file mã nguồn} & \textbf{Ngôn ngữ chính} & \textbf{LOC} & \textbf{Ghi chú} \\
\hline
Firmware Sensor Node & 3 biến thể & C/C++ (Arduino) & %todo & FreeRTOS \\
\hline
Firmware Gateway & 2 biến thể & C/C++ (Arduino) & %todo & Superloop \\
\hline
Backend Server & 14 controllers, 15 services & JavaScript (Node.js) & %todo & Express 4.21 \\
\hline
Frontend & 16 pages, 28 components & JavaScript (React) & %todo & Vite 8.0 \\
\hline
Database & 7 bảng, 1 view & SQL & %todo & TimescaleDB + PostGIS \\
\hline
Triển khai & 4 containers & YAML, Nginx conf & %todo & Docker Compose \\
\hline
\end{tabular}
\end{table}
