...
\hline
10 & Hiệu năng: realtime $\leq$ 2s, lịch sử $\leq$ 3s & Đạt & %todo: bổ sung kết quả đo latency thực tế trên production \\
\hline
11 & Độ tin cậy: 24/7, phát hiện offline & Đạt & Cron job 5 phút, ring buffer trên Gateway \\
\hline
12 & Khả năng mở rộng: Hub-Spoke & Đạt & Mục~\ref{subsection:4.1.1}, tự đăng ký Gateway \\
\hline
13 & Tính dễ sử dụng: responsive, đa ngôn ngữ & Đạt & Mục~\ref{subsection:4.2.3}, i18n Việt--Anh \\
\hline
14 & Bảo mật: JWT, bcrypt, audit log & Đạt & Mục~\ref{subsection:4.2.4}, kiểm thử TC6 Bảng~\ref{table:test_device} \\
\hline
\end{tabular}
\end{table}
...
%todo: Screenshot Quản lý tài khoản — user tự thêm hình
\begin{figure}[H]
    \centering
...
%todo: Screenshot Nhật ký hệ thống — user tự thêm hình
\begin{figure}[H]
    \centering
...
%todo: Bổ sung thông tin uptime thực tế (số ngày chạy liên tục) và screenshot trình duyệt truy cập https://datn.thamnguyen.dev — user tự thêm
