...
\textbf{Phân tích dữ liệu thực nghiệm:} 

*(GHI CHÚ DÀNH CHO SV: Chèn đánh giá về số liệu AQI/PM2.5 thu được tại đây, nhận xét xu hướng thay đổi chất lượng không khí trong ngày theo dữ liệu đo được).*

\begin{figure}[H]
    \centering
    % SV thay thế [width=\textwidth]{Hinhve/placeholder_data_chart.png} bằng file ảnh thực tế
    \includegraphics[width=\textwidth]{example-image}
    \caption{Biểu đồ dữ liệu PM2.5 và AQI thực tế thu thập qua 48 giờ}
    \label{fig:thuc_nghiem_data}
\end{figure}\subsection{So sánh với các hệ thống hiện có}
