...
\textbf{Dashboard quản trị.} Trang dashboard quản trị hiển thị thông tin tổng quan về hệ thống, bao gồm số lượng Gateway và Sensor Node, trạng thái online/offline, thời gian gửi cuối, mức pin (đối với Sensor Node) và cường độ tín hiệu LoRa (RSSI). 
...
\textbf{Quản lý tài khoản.} Trang quản lý tài khoản hiển thị danh sách các tài khoản trong hệ thống, hỗ trợ tìm kiếm, lọc và phân trang. Quản trị viên có thể thêm, sửa, xóa tài khoản thông qua modal form với xác thực dữ liệu đầu vào.
...
\textbf{Nhật ký hệ thống.} Trang nhật ký hệ thống hiển thị danh sách các sự kiện xảy ra trong hệ thống, hỗ trợ tìm kiếm, lọc và phân trang. Quản trị viên có thể xem nhật ký hệ thống thông qua modal form với xác thực dữ liệu đầu vào.
...
%todo: Screenshot kết quả lệnh `docker ps` cho thấy 4 container đang chạy — user tự thêm hình
