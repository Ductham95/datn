...
// =============================================================================
//  OLED DISPLAY IMPLEMENTATION — SSD1306 128×64 I2C (Wire)
//  Board 30 chân: dùng chung bus Wire (SDA=21, SCL=22) với CCS811 và AHT10
// =============================================================================

// Board 30 chân: dùng Wire mặc định (chung bus I2C với CCS811 và AHT10)
