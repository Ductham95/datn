...
// =============================================================================
//  PMS7003 DRIVER IMPLEMENTATION (30-pin board)
//  Protocol: UART 9600 baud, 32-byte data frame
//  Board 30 chân: Không có PMS_SET_PIN → PMS7003 luôn bật
// =============================================================================
...
bool pms7003_init() {
    ...
    // Board 30 chân: không có SET pin, PMS7003 luôn hoạt động
...
void pms7003_powerOn() {
    // Board 30 chân: không có SET pin → chỉ dùng lệnh UART wakeUp
    pms.wakeUp();
    LOG_MSG("PMS7003", "Bật quạt (warm-up)");
}

void pms7003_powerOff() {
    // Board 30 chân: không có SET pin → chỉ dùng lệnh UART sleep
    pms.sleep();
