...
// =============================================================================
//  GATEWAY CONFIGURATION (ESP32 30-pin / DOIT DevKit V1)
...
//  Pin mapping theo mạch AirMonitorGateway
// =============================================================================
...
// ===== Status LED (dùng LED_BUILTIN trên board 30 chân) =====
#define LED_STATUS_PIN 2  // LED tích hợp (GPIO2)
